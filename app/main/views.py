...
def index():
    ...
    economic_pitches = Pitch.get_pitches('economic')
    interview_pitches = Pitch.get_pitches('interview')
    product_pitches = Pitch.get_pitches('product')
    return render_template('index.html', title=title, economic=economic_pitches, interview=interview_pitches, product=product_pitches)
...
def business_pitches():
    ...
    return render_template("economic_pitches.html", pitches=pitches)
